...
- [Step Types](reference/step-types.md) — all built-in types: shell_exec, script_exec, prompt, k8s_job, http_request, gate, set_fact, load_artifact, assert
...
- [Using Postgres for Markov State](guides/postgres-state-store.md) — shared durable state store setup, Kubernetes wiring, and operations
